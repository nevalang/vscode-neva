...
4. The Neva compiler/LSP lives in `/Users/emil/projects/neva` (read-only). Use it for reference and to build LSP binaries when needed.
...
- LSP server source is in `/Users/emil/projects/neva/cmd/lsp`.
...
- Neva repo (main): `/Users/emil/projects/neva`
